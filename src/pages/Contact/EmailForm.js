...
export default function () {
  return (
    <Form action={`https://formspree.io/${process.env.USER_EMAIL}`} method="POST" style={formStyle}>
      ...
      <Form.Button color='green' id='submit-button'><Icon name='send'/>Submit</Form.Button>
    </Form>
  );
}
